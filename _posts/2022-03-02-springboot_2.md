...
CREATE TABLE `tb_lotto_list` (
  ...
  `lottery_no4` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '네번째 추첨번호',
  `lottery_no5` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '다섯번째 추첨번호',
  `lottery_no6` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '여섯번째 추첨번호',
  `lottery_bonus_no` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '보너스 추첨번호',
